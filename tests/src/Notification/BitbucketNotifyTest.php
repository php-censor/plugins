...
use PHPCensor\Plugins\Notification\BitbucketNotify;
use PHPUnit\Framework\TestCase;

class BitbucketNotifyTest extends TestCase
{
    public function testGetName()
    {
        $this->assertEquals('bitbucket_notify', BitbucketNotify::getName());
    }
