...
use PHPCensor\Plugins\Notification\HipchatNotify;
use PHPUnit\Framework\TestCase;

class HipchatNotifyTest extends TestCase
{
    public function testGetName()
    {
        $this->assertEquals('hipchat_notify', HipchatNotify::getName());
    }
